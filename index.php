...
<a href="/"><img src="meineiplogo.png" alt="DNS-Zone.NET" style="border: none;" id="logo" /></a>
			...
			<div class="footer">
				<a style="color: #808080; text-decoration: none;" href="mailto:info@dns-zone.net"><span style="font-size: 
10px;">info@dns-zone.net</span></a>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a style="color: #808080; text-decoration: none;" href="http://www.dns-zone.net"><span style="font-size: 10px;">&copy; 
DNS-Zone.NET</span></a>
			</div>
					</div>
	</body>
